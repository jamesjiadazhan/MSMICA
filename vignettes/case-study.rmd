...
# create a new folder called: MSMICA targeted metabolomics analysis
dir.create("MSMICA targeted metabolomics analysis")

# save the result as a csv file
write.csv(limma_outcome_1, "MSMICA targeted metabolomics analysis/rcc_targeted_MSMICA_HILICposC18neg_metabolites_limma_paired_t_test.csv", row.names = FALSE)
```
...
plotIndiv(final.splsda, comp = c(1,2), # plot samples from final model
          ...
          col.per.group = c("#F68B33", "#388ECC"), # set of colours
          title = 'Final sPLS-DA on the RCC study, comp 1 & 2')
...
# network analysis:
network(final.splsda, color.node = c("orange","lightblue"), cutoff = 0.63, size.node = 0.5, cex.node.name = 0.8, cex.edge.label = 0.8, symkey = TRUE) 
```
